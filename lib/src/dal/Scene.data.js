...
SceneDbManager.get = (scene) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const sceneRecord = yield common_data_1.daxClient.get(params).promise();
...
SceneDbManager.getIdsForUser = (user) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (user === null || user === void 0 ? void 0 : user.hideDemoScene) {
            return ids || [];
        }
        else if (ids === null || ids === void 0 ? void 0 : ids.length) {
            return [Scene_model_1.Scene.DemoSceneId, ...ids];
        }
        else {
            return [Scene_model_1.Scene.DemoSceneId];
        }
    }
    catch (error) {
        ErrorLogging_logic_1.AdminLogManager.logError(JSON.stringify(error), {
