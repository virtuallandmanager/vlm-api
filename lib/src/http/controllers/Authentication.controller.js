...
router.get("/web3", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!existingSession) {
            ...
            Session_logic_1.SessionManager.issueUserSessionToken(newSession);
...
router.post("/login", auth_1.web3AuthMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const status = ((user === null || user === void 0 ? void 0 : user.registeredAt) && ((_a = user === null || user === void 0 ? void 0 : user.roles) === null || _a === void 0 ? void 0 : _a.length)) || (userOrgs === null || userOrgs === void 0 ? void 0 : userOrgs.length) ? 200 : 201;
...
router.get("/restore", auth_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const userOrgs = yield Organization_logic_1.OrganizationManager.getUserOrgs(session.userId, Organization_model_1.Organization.Roles.ORG_OWNER);
        const status = ((user === null || user === void 0 ? void 0 : user.registeredAt) && ((_b = user === null || user === void 0 ? void 0 : user.roles) === null || _b === void 0 ? void 0 : _b.length)) || (userOrgs === null || userOrgs === void 0 ? void 0 : userOrgs.length) ? 200 : 201;
        return res.status(status).json({
            text: "Successfully authenticated.",
            session,
            user,
...
router.post("/decentraland", (0, decentraland_crypto_middleware_1.express)({ expiration: utils_1.VALID_SIGNATURE_TOLERANCE_INTERVAL_MS }), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        Session_logic_1.SessionManager.issueAnalyticsSessionToken(session);
