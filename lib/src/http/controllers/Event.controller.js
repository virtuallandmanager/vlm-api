...
router.get("/migrate/all", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield giveawayItems.forEach((item) => __awaiter(void 0, void 0, void 0, function* () {
            const gItem = new Giveaway_model_1.Giveaway.Item(Object.assign(Object.assign({}, item), { imageLink: `https://peer.decentraland.org/lambdas/collections/contents/urn:decentraland:matic:collections-v2:${item.contractAddress}:${item.itemId}/thumbnail` }));
            gItems.push(gItem);
