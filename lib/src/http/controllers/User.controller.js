...
router.post("/setup", auth_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (luxon_1.DateTime.now().toUnixInteger() < luxon_1.DateTime.fromFormat("05/01/2023", "mm/dd/yyyy").plus({ months: 6 }).toUnixInteger()) {
            userInfo.roles.push(User_model_1.User.Roles.EARLY_ACCESS);
        }
