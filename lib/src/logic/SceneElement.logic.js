    ...
    try {
        ...
        if (sks && sks.length) {
            for (let i = 0; i < sks.length; i++) {
                const sceneElement = yield Scene_logic_1.SceneManager.getSceneElementById(pk, sks[i]);
...
SceneElementManager.updateInstance = (message) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield Scene_data_1.SceneDbManager.updateInstance(message.instanceData);
    }
    catch (error) {
