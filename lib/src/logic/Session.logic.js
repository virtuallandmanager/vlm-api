...
SessionManager.validateSessionToken = (sessionToken) => __awaiter(void 0, void 0, void 0, function* () {
    let decodedSession;
    try {
        decodedSession = jsonwebtoken_1.default.verify(sessionToken, process.env.JWT_ACCESS_SECRET);
    }
    catch (error) {
        console.log(error);
        return false;
...
SessionManager.validateSignatureToken = (config) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        decodedSession = jsonwebtoken_1.default.verify(signatureToken, process.env.JWT_ACCESS_SECRET);
    }
    catch (error) {
        console.log(error);
        return;
    ...
    if (!decodedSession) {
        ErrorLogging_logic_1.AdminLogManager.logError("No Session Decoded", {
            ...
            object: jsonwebtoken_1.default.verify(signatureToken, process.env.JWT_ACCESS_SECRET),
        });
        return;
    }
