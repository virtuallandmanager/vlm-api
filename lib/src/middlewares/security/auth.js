...
exports.alchemyWebhook = exports.userAuthMiddleware = exports.analyticsAuthMiddleware = exports.vlmAdminMiddleware = exports.web3AuthMiddleware = exports.authMiddleware = void 0;
...
function authMiddleware(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Verify the token
        try {
            const session = yield Session_logic_1.SessionManager.validateUserSessionToken(sessionToken);
            if (!session) {
...
function analyticsAuthMiddleware(client, message, next) {
    var _a, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        let session;
        ...
        if (sessionToken) {
            ...
            session = yield Session_logic_1.SessionManager.validateAnalyticsSessionToken(sessionToken);
        }
        if (((_b = (_a = client === null || client === void 0 ? void 0 : client.auth) === null || _a === void 0 ? void 0 : _a.session) === null || _b === void 0 ? void 0 : _b.sessionToken) && ((_c = client.auth.session) === null || _c === void 0 ? void 0 : _c.sessionToken) !== sessionToken) {
...
exports.analyticsAuthMiddleware = analyticsAuthMiddleware;
function userAuthMiddleware(client, message, next) {
    return __awaiter(this, void 0, void 0, function* () {
        let session;
        const { sessionToken, sceneId } = message;
        // Perform token validation here
        if (sessionToken) {
            // Token is valid, allow access to the next message handling logic
            session = yield Session_logic_1.SessionManager.validateUserSessionToken(sessionToken);
        }
        if (session) {
            next(session);
            return;
