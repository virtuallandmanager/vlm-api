...
(function (History) {
    ...
    class Update {
        constructor(config) {
            ...
            else if (config.action && config.element && config.property) {
                this.sk = `${config.action}:${config.element}:${config.property}`;
            }
            else if (config.action && config.element) {
                this.sk = `${config.action}:${config.element}`;
            }
