...
function handleSessionStart(client, sessionConfig, room) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield (0, auth_1.wsAuthMiddleware)(client, { sessionToken, sceneId }, (session) => __awaiter(this, void 0, void 0, function* () {
                client.auth = { session, user: {} };
                let dbSession = yield Session_logic_1.SessionManager.startAnalyticsSession(Object.assign(Object.assign({}, sessionConfig), { sk: client.auth.sessionId })), world = session.worldLocation.world, scene = yield Scene_logic_1.SceneManager.obtainScene(new Scene_model_1.Scene.Config({ sk: sceneId, worlds: [world] })), scenePreset;
                if (scene.worlds && !scene.worlds.includes(world)) {
                    yield Scene_logic_1.SceneManager.updateSceneProperty({ scene, prop: "worlds", val: [...scene.worlds, world] });
                }
                else if (!scene.worlds || scene.worlds.length == 0) {
                    yield Scene_logic_1.SceneManager.updateSceneProperty({ scene, prop: "worlds", val: [world] });
                }
...
function handleSessionAction(client, message, room) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield (0, auth_1.wsAuthMiddleware)(client, { sessionToken, sceneId }, () => __awaiter(this, void 0, void 0, function* () {
...
function handleSessionEnd(client, message) {
    return __awaiter(this, void 0, void 0, function* () {
...
function handleSceneLoadRequest(client, message, room) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            let dbScene = yield Scene_logic_1.SceneManager.loadScene(message.sceneId);
